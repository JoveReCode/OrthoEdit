...
def compute_z(
    ...
    if old_ids[0] == tok.bos_token_id or old_ids[0] == tok.unk_token_id:
        old_ids = old_ids[1:]
    ...
    def edit_output_fn(cur_out, cur_layer):
        ...
        if cur_layer == hparams.layer_module_tmp.format(layer):
            ...
            for i, idx in enumerate(lookup_idxs):
                # print(delta.shape, cur_out[0].shape, cur_out.shape)
    ...
    for it in range(hparams.v_num_grad_steps):
        ...
        # Forward propagation
        # print("layer module:", hparams.layer_module_tmp.format(layer))
        # m = nethook.get_module(model, hparams.layer_module_tmp.format(layer))
        # print(type(m), m.__class__.__module__)
        ...
        target_prob = torch.exp(-nll_loss_each).mean().item()
